...
public class LineViewBloodpress extends View {
	...
	public LineViewBloodpress(Context context, float[] values, ArrayList<String> xvalue, ArrayList<String> xlabel,
...
//		canvas.scale(mScaleFactor, 1f);
		...
		canvas.drawLine(marginLeft, marginTop + h - 12*cHeight, marginLeft, marginTop + h, pen); // y축
		
		
		for(int i=0; i<13; i++){ //가로선
//			canvas.drawLine(marginLeft + 3,marginTop + h - i*cHeight, marginLeft + w + 40, marginTop + h - i*cHeight, dashPen);
			canvas.drawLine(marginLeft - 8, marginTop + h - i*cHeight, marginLeft + 8, marginTop + h - i*cHeight, pen); // y축
		}
		
		
//		canvas.drawLine(marginLeft - 3, marginTop + h, marginLeft + w + 50, marginTop + h, pen); // x축
		...
		/*canvas.drawText("혈압(mmhg)",2, marginTop + h + 20, txtPen); //y축 타이틀
		
		txtPen.setColor(Color.YELLOW);
		txtPen.setTextSize(20);*/
		canvas.drawText("혈압(mmhg)",2, marginTop + 17, txtPen); //y축 타이틀
...
//		int cHeight = (int)((h-20)/10);
		...
		for(int i=0; i<13; i++){ //가로선
//			canvas.drawLine(marginLeft + 3,marginTop + h - i*cHeight, marginLeft + w + 40, marginTop + h - i*cHeight, dashPen);
			canvas.drawText(i*20+"", marginLeft - 40, marginTop + h - i*cHeight + 5, txtPen1);
		}
