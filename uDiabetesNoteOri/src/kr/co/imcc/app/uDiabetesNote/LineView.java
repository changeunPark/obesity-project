...
public class LineView extends View {
	...
	public LineView(Context context, float[] values, ArrayList<String> xvalue, ArrayList<String> xlabel,
...
//		canvas.scale(mScaleFactor, 1f);
		...
		canvas.drawLine(marginLeft, marginTop + h - 12*cHeight, marginLeft, marginTop + h, pen); //세로기준선
...
//		txtPen.setTextAlign(Paint.Align.LEFT);
		...
		/*canvas.drawText("혈당(mm/dL)",2, marginTop + h + 33, txtPen); //y축 타이틀
		
		txtPen.setColor(0xFF3380A0);
		txtPen.setTextSize(20);*/
		
		canvas.drawText("",2, marginTop + 17, txtPen); //y축 타이틀
		//혈당기울기
		txtPen.setStrokeWidth(1);		
		//혈당색
...
//			canvas.drawLine(marginLeft + 3,marginTop + h - i*cHeight, marginLeft + w + 40, marginTop + h - i*cHeight, dashPen);
			canvas.drawText(i*50+"", marginLeft - 40, marginTop + h - i*cHeight + 5, txtPen1);
		}
