...
public class tActivity2_3_5 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layer6_bloodpress_5);
        ...
        webView.loadUrl("http://gilcare.welltizen.com/mobile/guide_pressure_food5.html");
		...
		{ // back
			...
			{											
				...
				{	
					...
					if(url.equals("http://gilcare.welltizen.com/mobile/guide_pressure_food5.html"))
					{
						onBackPressed();
					}
					else
