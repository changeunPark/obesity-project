...
public class tActivity4_1 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		title.setText("비만식습관에 의한 식이추천");
		btTestStart.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				Intent intent = new Intent(tActivity4_1.this,
						kr.co.imcc.app.uDiabetesNote.tActivity4_1_1.class);
